              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php }?>
                    <form action='<?php echo base_url();?>manager-category/add' method='POST'data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name='category-slug-name' required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
